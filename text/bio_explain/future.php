...
会場：ニュージャパン<br />
<br />
新宿風林会館にて開催されたMaltine Records主催イベントに、パフォーマー＆施工として参加。パフォーマンスは、DJシーザーと共に全身白タイツにLEDの装飾をつけた渋家メンバーたちが会場中を練り歩きダンス。施工は準備2時間、撤収１時間のなかでプロジェクターを5台、3m&times;3mのスクリーン2つを仕切る「エクストリーム搬出」を実現させた。<br />
<br />
<a href="http://ameblo.jp/kabutine0602/" target="_blank">[Web]</a>
</div>
